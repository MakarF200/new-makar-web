            ...
            <div
               ...
               <div class="max-w-3xl flex-none sm:max-w-5xl lg:max-w-none">
                  <div class="-m-2 rounded-xl bg-gray-900/5 p-2 lg:-m-4 lg:rounded-2xl lg:p-4">
                     <img :src="projectStoreDataMesSystem.showLocImgUrl" alt="App screenshot" width="2432" height="1442"
...
const projectStoreDataMesSystem = computed(() => projectStore.projectMainData[1])
...
function changeRotationData(vueLocRechangeName: keyof ShowThisVueRotationImg, StoreImportListLoc: number) {
   showThisProjectImg.value[vueLocRechangeName].locImgUrl = projectStoreDataMesSystem.value.rotation[StoreImportListLoc].locImgUrl
   showThisProjectImg.value[vueLocRechangeName].imgUrl = projectStoreDataMesSystem.value.rotation[StoreImportListLoc].imgUrl
   showThisProjectImg.value[vueLocRechangeName].key = projectStoreDataMesSystem.value.rotation[StoreImportListLoc].key
   showThisProjectImg.value[vueLocRechangeName].id = projectStoreDataMesSystem.value.rotation[StoreImportListLoc].id
}
