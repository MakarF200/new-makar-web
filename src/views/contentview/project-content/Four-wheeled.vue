...
const projectStoreDataFourWheeled = computed(
  () => projectStore.projectMainData[0]
);
/**
...
function changeRotationData(
  ...
  showThisProjectImg.value[vueLocRechangeName].locImgUrl =
    projectStoreDataFourWheeled.value.rotation[StoreImportListLoc].locImgUrl;
  showThisProjectImg.value[vueLocRechangeName].imgUrl =
    projectStoreDataFourWheeled.value.rotation[StoreImportListLoc].imgUrl;
  showThisProjectImg.value[vueLocRechangeName].key =
    projectStoreDataFourWheeled.value.rotation[StoreImportListLoc].key;
  showThisProjectImg.value[vueLocRechangeName].id =
    projectStoreDataFourWheeled.value.rotation[StoreImportListLoc].id;
}
