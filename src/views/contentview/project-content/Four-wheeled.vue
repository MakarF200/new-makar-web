<template>
  <div class="relative isolate overflow-hidden bg-white">
    <div class="">
        ...
        <div
          ...
          <div class="max-w-3xl flex-none sm:max-w-5xl lg:max-w-none">
            <div class="-m-2 rounded-xl bg-gray-900/5 p-2 lg:-m-4 lg:rounded-2xl lg:p-4">
              <img :src="projectStoreDataFourWheeled.showLocImgUrl" alt="App screenshot" width="2432" height="1442"
      ...
      <!-- 轮播图片 -->
      <div class=" bg-purple-200 rounded-box w-full py-8 mt-16">
        图片
      </div>
        ...
        <div class="mx-auto max-w-7xl px-12 py-16 sm:px-6 sm:py-24 lg:px-8">
          ...
          <div class="mt-6 grid grid-cols-1 gap-y-6 sm:grid-cols-2 sm:grid-rows-2 sm:gap-x-6 lg:gap-8">
            ...
            <div class="group relative aspect-[2/1] overflow-hidden rounded-lg sm:aspect-auto">
              <img :src="showThisProjectImg.rightTopShow.locImgUrl" :alt="showThisProjectImg.rightTopShow.key"
                class="absolute size-full object-cover group-hover:opacity-75" />
            </div>
            <div class="group relative aspect-[2/1] overflow-hidden rounded-lg sm:aspect-auto">
              <img :src="showThisProjectImg.rightBotShow.locImgUrl" :alt="showThisProjectImg.rightBotShow.key"
                class="absolute size-full object-cover group-hover:opacity-75" />
            </div>
          </div>
...
const projectStoreDataFourWheeled = computed(() => projectStore.projectMainData[0])
/**
 ...
 */
function changeRotationData(vueLocRechangeName: keyof ShowThisVueRotationImg, StoreImportListLoc: number) {
  showThisProjectImg.value[vueLocRechangeName].locImgUrl = projectStoreDataFourWheeled.value.rotation[StoreImportListLoc].locImgUrl
  showThisProjectImg.value[vueLocRechangeName].imgUrl = projectStoreDataFourWheeled.value.rotation[StoreImportListLoc].imgUrl
  showThisProjectImg.value[vueLocRechangeName].key = projectStoreDataFourWheeled.value.rotation[StoreImportListLoc].key
  showThisProjectImg.value[vueLocRechangeName].id = projectStoreDataFourWheeled.value.rotation[StoreImportListLoc].id
}
